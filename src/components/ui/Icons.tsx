...
export const IconZalo = ({ size = SIZE, ...props }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <rect width="24" height="24" rx="6" fill="#0068FF" />
    <text x="12" y="16.5" fontFamily="Helvetica, Arial, sans-serif" fontSize="11" fontWeight="bold" fill="white" textAnchor="middle">Zalo</text>
  </svg>
);

export const IconGoogle = ({ size = SIZE, ...props }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
